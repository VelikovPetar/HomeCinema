...
public class SearchActivity extends Activity {
    ...
    private void initializeUI() {
        ...
        resultsList.setOnItemClickListener(new MovieListOnItemClickHandler());
    }
    ...
    // Actions when clicking on a displayed movie
    private class MovieListOnItemClickHandler implements AdapterView.OnItemClickListener {
